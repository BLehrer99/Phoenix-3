...
void writeSD() {
  ...
  snprintf(str, sizeof(str),
           "T%s%07ld, mag: %03d, agl: %03.1f, ascentRate: %03.1f, acceleration: %03.1f, pitch: %03d, yaw: %03d, roll: %03d, main ignition: %s, landing ignition: %s, fairing: %s, rollComp: %03d, launchPitch: %03d, legs[0]: %03d, legs[1]: %03d, legs[2]: %03d, legs[3]: %03d, AFTS: %s, message: "
